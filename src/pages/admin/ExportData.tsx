...
const TABLES = [
  ...
  { name: "project_members", label: "Miembros", description: "Estudiantes, directores y jurados por proyecto", isAdmin: false },
  ...
  { name: "endorsements", label: "Avales", description: "Avales de directores", isAdmin: false },
